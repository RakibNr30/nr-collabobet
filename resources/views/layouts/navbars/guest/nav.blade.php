<!-- Navbar -->
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 {{--my-3--}} {{ (Request::is('static-sign-up') ? 'w-100 shadow-none  navbar-transparent' : 'blur shadow py-2 start-0 end-0 mx4') }}">
  <div class="container-fluid {{ (Request::is('static-sign-up') ? 'container' : 'container-fluid') }}">
    ...
    <div class="collapse navbar-collapse" id="navigation">
      <ul class="navbar-nav mx-auto">
        ...
        @endif
        <li class="nav-item">
          <a class="nav-link me-2" href="{{ auth()->user() ? url('static-sign-up') : route('register.create') }}">
