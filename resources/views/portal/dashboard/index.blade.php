                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Verified Transactions</p>
                                            <h5 class="font-weight-bolder mb-0">
                                                {{ $statistics->total_accepted_transaction }}
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Verified Amount</p>
                                            <h5 class="font-weight-bolder mb-0">
                                                {{ $statistics->total_accepted_transaction_amount }}
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
