                                        ...
                                        <form role="form text-left" method="POST"
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control"
                                                       placeholder="Your friend's affiliate code"
                                                       name="refer_affiliate_code" id="refer_affiliate_code"
                                                       aria-label="Refer Affiliate Code"
                                                       aria-describedby="refer-affiliate-code-addon"
                                                       value="{{ old('refer_affiliate_code') }}">
